<%@ Page Title="Add CarrierRecord" Language="C#" MasterPageFile="~/EditPrices.master" AutoEventWireup="true" CodeBehind="AddCarrierRecord.aspx.cs" Inherits="ClientSystem.AddCarrierRecords" %>
<asp:Content ID="ContentAddCarrierRecord" ContentPlaceHolderID="ChildContent" runat="server">
    <h2><%: Title %></h2>
    <asp:FormView runat="server" ID="addCarrierRecord"
        ItemType="ClientSystem.Models.CarrierRecord"
        InsertMethod="addCarrierRecord_InsertItem" DefaultMode="Insert"
        RenderOuterTable="false" OnItemInserted="addCarrierRecord_ItemInserted">
        <InsertItemTemplate>
            <fieldset>
                 <div>
                    <span class="col-sm-2 control-label">Carrier Record Name:</span>
                    <asp:TextBox runat="server" ID="CarrierRecordNameTextBox" Text=" <%#: BindItem.Name %>" CssClass="form-control">                           
                    </asp:TextBox>
                </div>
