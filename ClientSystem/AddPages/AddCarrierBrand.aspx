<%@ Page Title="Add Carrier Brand" Language="C#" MasterPageFile="~/EditPrices.master" AutoEventWireup="true" CodeBehind="AddCarrierBrand.aspx.cs" Inherits="ClientSystem.AddCarrierBrand" %>
<asp:Content ID="ContentAddCarrierBrand" ContentPlaceHolderID="ChildContent" runat="server">
    <h2><%: Title %></h2>
    <asp:FormView runat="server" ID="addCarrierBrand"
        ItemType="ClientSystem.Models.CarrierBrand"
        InsertMethod="addCarrierBrand_InsertItem" DefaultMode="Insert"
        RenderOuterTable="false" OnItemInserted="addCarrierBrand_ItemInserted">
        <InsertItemTemplate>
            <fieldset>
                 <div>
                    <span class="col-sm-2 control-label">Carrier Brand Name:</span>
                    <asp:TextBox runat="server" ID="CarrierBrandNameTextBox" Text=" <%#: BindItem.Name %>" CssClass="form-control">                           
                    </asp:TextBox>
                </div>
